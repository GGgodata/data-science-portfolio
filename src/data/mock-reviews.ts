...
export const MOCK_REVIEWS = {
  ...
  reviews: [
    ...
    { id: 'r3', clientName: 'אסתר ל.', clientPhoto: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=120&q=80', rating: 5, date: '2026-05-06', text: 'מנקה מצוינת. שמתי לב גם לפרטים הקטנים שאני בעצמי לא הייתי שמה לב אליהם.', jobCategory: 'ניקיון שוטף', hasResponse: false },
    { id: 'r4', clientName: 'דניאל ק.', clientPhoto: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=120&q=80', rating: 5, date: '2026-04-29', text: 'מקצוענית אמיתית. עבדה מהר, לא בזבזה זמן, התוצאה מעולה. ממליץ בחום.', jobCategory: 'ניקיון שוטף', hasResponse: false },
