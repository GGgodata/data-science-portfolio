...
export default function Sidebar({ provider }: SidebarProps) {
  ...
  return (
    <aside className="fixed top-0 right-0 h-screen w-[280px] bg-cream/95 backdrop-blur-sm border-l border-stone/20 flex flex-col z-40">
